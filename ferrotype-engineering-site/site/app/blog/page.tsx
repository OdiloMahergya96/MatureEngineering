...
export const metadata = buildMetadata({
  ...
  description: "Articles on mechanical design, automation, manufacturing, CAD, DFMA, lean manufacturing, and engineering management.",
  path: "/blog",
});
    ...
    <Section tone="canvas" className="pt-24">
      <Container>
        <Reveal className="max-w-3xl">
          <p className="spec-label mb-3">Engineering Blog</p>
