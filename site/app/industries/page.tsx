...
export const metadata = buildMetadata({
  title: "Industries",
  description: "Engineering support for automotive, plastic, packaging, food, mining, oil & gas, power plant, and machine builder industries.",
  path: "/industries",
});
      ...
      <Section tone="canvas" className="pt-24 pb-14">
        <Container>
          <Reveal className="max-w-3xl">
            <p className="spec-label mb-3">Industries</p>
            ...
            <p className="mt-6 text-lg text-graphite/70 dark:text-white/60">
              Every sector has different failure modes, regulatory pressure, and cost structures. Our engineers bring
            ...
            {industries.map((industry, i) => (
              <Reveal key={industry.slug} delay={(i % 4) * 0.05}>
                <div id={industry.slug} className="scroll-mt-24 rounded-2xl border border-graphite/10 bg-white p-8 dark:border-white/10 dark:bg-graphite-dark">
                  <SpecRow index={i + 1} total={industries.length} label="Sector" />
                  ...
                  <p className="mt-5 spec-label">Common Challenges</p>
