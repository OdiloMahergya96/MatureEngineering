...
export const metadata = buildMetadata({
  title: "Services",
  description: "Mechanical engineering, product development, manufacturing engineering, automation, and engineering consulting services.",
  path: "/services",
});
        ...
        <Container>
          <Reveal className="max-w-3xl">
            ...
            <h1 className="font-display text-4xl font-semibold text-graphite dark:text-white md:text-5xl">
              Eighteen disciplines, one accountable engineering team
            </h1>
            <p className="mt-6 text-lg text-graphite/70 dark:text-white/60">
              Every service below is delivered by our own engineers, coordinated through our manufacturing network
              where physical production is required.
            </p>
          </Reveal>
        </Container>
      </Section>
