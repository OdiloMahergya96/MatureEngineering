...
export const metadata = buildMetadata({
  title: "Kontak",
  description: "Minta penawaran engineering atau jadwalkan konsultasi dengan Ferrotype Engineering.",
  path: "/contact",
});
    ...
    <Section tone="canvas" className="pt-24">
      <Container>
        <div className="grid gap-14 lg:grid-cols-[1fr_1.4fr]">
          <Reveal>
            <p className="spec-label mb-3">Kontak</p>
            <h1 id="consultation" className="scroll-mt-24 font-display text-3xl font-semibold text-graphite dark:text-white md:text-4xl">
              Yuk diskusikan masalah engineering Anda
            </h1>
            <p className="mt-4 text-graphite/70 dark:text-white/60">
              Ceritakan masalah yang ingin Anda selesaikan. Seorang engineer — bukan sales — akan meninjau permintaan
              Anda dan merespons dalam 24 jam.
            </p>
